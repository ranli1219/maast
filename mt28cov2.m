function [dCov,scalef,maxrat] = mt28cov2(satxyz,satxyzdot,G,sig2_mon)
...
global UDRE2_SIG_SV_H UDRE2_SIG_SV_C UDRE2_SIG_SV_L UDRE2_SIG_SV_T ...
        ...
        UDRE2_MT28_MIN_CNMP2
% note: check signs of G matrix!

% a priori weighting matrix
inv_P0 = diag(1./[UDRE2_SIG_SV_H^2 UDRE2_SIG_SV_C^2 UDRE2_SIG_SV_L^2 UDRE2_SIG_SV_T^2]);
...
sig2_mon=max(sig2_mon, e*UDRE2_MT28_MIN_CNMP2);
W = diag(e./sig2_mon);
...
sig_hdot = UDRE2_SIG_DOT_H*UDRE2_T_PREDEG;
sig_cdot = UDRE2_SIG_DOT_C*UDRE2_T_PREDEG;
sig_ldot = UDRE2_SIG_DOT_L*UDRE2_T_PREDEG;
