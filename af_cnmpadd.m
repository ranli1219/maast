function sig2 = af_wrscnmpadd(del_t,el)
%*************************************************************************
...
%*************************************************************************
%
%AF_WRSCNMPADD calculate psueudorange confidence (variance) 
%               per CNMP ADD A014-008B
%SIG2=AF_WRSCNMPADD(DEL_T, EL)
...
%modified 30 April 2001 by Wyant Chan
%   - name change
